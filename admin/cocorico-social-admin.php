...
<h3><?php echo __('Donation', 'cocosocial');?></h3>

<p style="font-size: 15px;"><?php echo __('If you like this plugin, you can make a donation to support the development.', 'cocosocial'); ?> </p>

<p>
    <form name="_xclick" action="https://www.paypal.com/uk/cgi-bin/webscr" method="post" target="_blank">
        <label for="amount">
            <h4><?php echo __('Amount', 'cocosocial'); ?></h4>
            <input style="display: block" type="number" name="amount" value="5">    
        </label><br>
        <input type="hidden" name="cmd" value="_donations">
        <input type="hidden" name="business" value="diallo.mouhamadou@hubsine.com">
        <a href="../../../../../PLUGINS/hubsine-social-share/trunk/readme.txt"></a>
        <input type="hidden" name="item_name" value="Donation for Hubsine">
...
<?php 
    echo __('You can do a donate here : <a target="_blank" href="https://hubsine.com/donation/">donation page</a>');
?>
...
////////////////////////////////////
// Hubsine Cocorico Framework
////////////////////////////////////

$form = new Cocorico(COCO_SOCIAL_COCORICO_PREFIX);

$form->startWrapper('titre');
$form->component('raw', __('Hubsine Social Share Settings', 'cocosocial'));
$form->endWrapper('titre');

$form->groupHeader(array(
    'general'=>__('General', 'cocosocial'), 
...
$form->orderedList('networks_blocks',
				...
				array(   
                                     ...
                                     'twitter'=>__('Twitter : the share number of a post returned by Twitter API is limited to 100. it\'s a Twitter API restrictions.', 'cocosocial'),
...
$form->setting(array('type'=>'checkbox',
					 'label'=>__('Button width on mobile', 'cocosocial'),
					 'name'=>'btn_width_on_mobile',
					 'checkboxes'=>array(
					 	 1 =>__('Check for the full width of the button on mobile.', 'cocosocial')
					 ),
					 'description'=>__("Each button take full witdh on mobile.", 'cocosocial')
					 ));
...
$form->setting(array(
                                        ...
                                        'description' => __("Facebook API setting is optional but to use see : http://www.shoutmeloud.com/get-facebook-app-id-secret-key.html")
                                    ));
$form->setting(array(
                                        'type'  => 'text',
...
$form->setting(array(
                                        ...
                                        'description'   => __('Twitter API key must be define. To use see : https://iag.me/socialmedia/how-to-create-a-twitter-app-in-8-easy-steps/')
                                    ));
$form->setting(array(
                                        'type'  => 'text',
                                        'label' => __('Twitter API Secret'),
                                        'name'  => 'twitter_api_secret',
                                        'description'   => __('Twitter API secret must be define. To use see : https://iag.me/socialmedia/how-to-create-a-twitter-app-in-8-easy-steps/')
                                    ));
...
<?php _e('Hubsine Social Share is brought to you by','cocosocial'); ?> <a href="https://hubsine.com/" target="_blank">Hubsine</a> 
